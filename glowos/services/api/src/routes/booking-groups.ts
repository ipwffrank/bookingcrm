...
bookingGroupsRouter.patch(
  ...
  async (c) => {
    ...
    // Operating-hours gate — same rule as on create. If any service in the
...
// outsideHoursViolation now lives in lib/operating-hours-gate.ts so all
// endpoints that create/move bookings can share the same check.
